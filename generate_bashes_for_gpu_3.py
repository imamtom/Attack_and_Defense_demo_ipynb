...
# 固定参数 --iid False --alpha 0.1 --given_size 4096 --gpu_id 3
    ...
    for dataset in dataset_name:
        for attack_method in attack_methods:
            for defense_method in defense_methods:
                f.write('python run.py --dataset {} --attack_method {} --defense_method {} --iid False --alpha 0.1 --given_size 4096 --gpu_id 3\n'.format(dataset, attack_method, defense_method))