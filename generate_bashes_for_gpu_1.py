...
# 生成的命令会使用gpu 1, 固定参数 --iid False --alpha 10 --given_size 4096 --gpu_id 1
    ...
    for dataset in dataset_name:
        for attack_method in attack_methods:
            for defense_method in defense_methods:
                f.write('python run.py --dataset {} --attack_method {} --defense_method {} --iid False --alpha 10 --given_size 4096 --gpu_id 1\n'.format(dataset, attack_method, defense_method))